...
function makeByXFunction(source) {
  return function(options, alternateSource) {
    ...
    if ("default" in options) return (_options$val = options[val2]) !== null && _options$val !== void 0 ? _options$val : options.default;
    return options[val2];
  };
}
...
function applyCached(entry, options) {
  ...
  if (outfitName) {
    ...
    if (familiarEquip) (0, import_kolmafia7.equip)($slot(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral2(["familiar"]))), familiarEquip);
  } else {
  ...
  _createClass7(CombatStrategy2, [{
    ...
    value: function macro(_macro, monsters, prepend) {
      ...
      if (monsters === void 0) {
        ...
        if (monsters instanceof import_kolmafia8.Monster) monsters = [monsters];
    ...
    value: function clone() {
      ...
      if (this.starting_macro) result.starting_macro = _toConsumableArray6(this.starting_macro);
      if (this.default_macro) result.default_macro = _toConsumableArray6(this.default_macro);
      ...
      if (this.default_autoattack) result.default_autoattack = _toConsumableArray6(this.default_autoattack);
    ...
    value: function compile(resources, defaults, location) {
      ...
      if (this.default_macro) result.step.apply(result, _toConsumableArray6(this.default_macro.map(function(macro2) {
        return undelay(macro2);
      })));
    ...
    value: function compileAutoattack() {
      ...
      result.step(monster_macros.compile());
      if (this.default_autoattack) result.step.apply(result, _toConsumableArray6(this.default_autoattack.map(function(macro) {
        return undelay(macro);
      })));
      return result;
    }
...
var CombatResources = /* @__PURE__ */ function() {
  ...
  _createClass7(CombatResources2, [{
    ...
    value: function getMacro(action) {
      ...
      if (resource.do instanceof import_kolmafia8.Item) return new Macro().item(resource.do);
      if (resource.do instanceof import_kolmafia8.Skill) return new Macro().skill(resource.do);
...
var Outfit = /* @__PURE__ */ function() {
  ...
  _createClass8(Outfit2, [{
    ...
    value: function isAvailable(item) {
      ...
      if ((0, import_kolmafia9.booleanModifier)(item, "Single Equip") && this.equippedAmount(item) > 0) return false;
      return true;
    }
    /**
    ...
    value: function haveEquipped3(item, slot) {
      if (slot === void 0) return this.equippedAmount(item) > 0;
    ...
    value: function equipNonAccessory(item, slot) {
      if ($slots(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))).includes((0, import_kolmafia9.toSlot)(item))) return false;
      if (slot !== void 0 && slot !== (0, import_kolmafia9.toSlot)(item)) return false;
      if (this.equips.has((0, import_kolmafia9.toSlot)(item))) return false;
      switch ((0, import_kolmafia9.toSlot)(item)) {
        ...
        case $slot(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral3(["familiar"]))):
          if (this.familiar !== void 0 && !(0, import_kolmafia9.canEquip)(this.familiar, item)) return false;
      }
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral3(["familiar"]))) && !(0, import_kolmafia9.canEquip)(item)) return false;
    ...
    value: function equipAccessory(item, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray7($slots(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))))).includes(slot)) return false;
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral3(["acc1"])))) return false;
      if (!(0, import_kolmafia9.canEquip)(item)) return false;
      if (slot === void 0) {
    ...
    value: function equipUsingDualWield(item, slot) {
      if (![void 0, $slot(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral3(["off-hand"])))].includes(slot)) return false;
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral3(["weapon"])))) return false;
      ...
      if (this.equips.has($slot(_templateObject143 || (_templateObject143 = _taggedTemplateLiteral3(["off-hand"]))))) return false;
      if (!have($skill(_templateObject153 || (_templateObject153 = _taggedTemplateLiteral3(["Double-Fisted Skull Smashing"]))))) return false;
    ...
    value: function equipUsingFamiliar(item, slot) {
      if (![void 0, $slot(_templateObject213 || (_templateObject213 = _taggedTemplateLiteral3(["familiar"])))].includes(slot)) return false;
      if (this.equips.has($slot(_templateObject223 || (_templateObject223 = _taggedTemplateLiteral3(["familiar"]))))) return false;
    ...
    value: function equipSpec(spec) {
      ...
      if (spec.modifier) {
        var _this$modifier;
        if (Array.isArray(spec.modifier)) (_this$modifier = this.modifier).push.apply(_this$modifier, _toConsumableArray7(spec.modifier));
    ...
    value: function equip4(thing, slot) {
      ...
      if (thing instanceof import_kolmafia9.Item) return this.equipItem(thing, slot);
      if (thing instanceof import_kolmafia9.Familiar) return this.equipFamiliar(thing);
    ...
    value: function _dress(refreshed) {
      ...
      if (this.familiar !== void 0 && (0, import_kolmafia9.myFamiliar)() !== this.familiar) throw "Failed to fully dress (expected: familiar ".concat(this.familiar, ")");
    ...
    value: function current() {
      ...
      if ((0, import_kolmafia9.haveEquipped)($item(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral3(["Crown of Thrones"]))))) outfit2.riders.set($slot(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral3(["crown-of-thrones"]))), (0, import_kolmafia9.myEnthronedFamiliar)());
      if ((0, import_kolmafia9.haveEquipped)($item(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral3(["Buddy Bjorn"]))))) outfit2.riders.set($slot(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral3(["buddy-bjorn"]))), (0, import_kolmafia9.myBjornedFamiliar)());
...
var Engine = /* @__PURE__ */ function() {
  ...
  _createClass9(Engine2, [{
    ...
    value: function dress(task, outfit2) {
      if (task.do instanceof import_kolmafia10.Location) (0, import_kolmafia10.setLocation)(task.do);
      outfit2.dress();
    }
    ...
    value: function _do(task) {
      ...
      if (result instanceof import_kolmafia10.Location) (0, import_kolmafia10.adv1)(result, -1, "");
      (0, import_kolmafia10.runCombat)();
      while ((0, import_kolmafia10.inMultiFight)()) (0, import_kolmafia10.runCombat)();
      if ((0, import_kolmafia10.choiceFollowsFight)()) (0, import_kolmafia10.runChoice)(-1);
    }
    /**
...
var worksheds = [[$item(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral5(["none"]))), "Do nothing"], [$item(_templateObject215 || (_templateObject215 = _taggedTemplateLiteral5(["model train set"]))), "Swap to model train set"], [$item(_templateObject311 || (_templateObject311 = _taggedTemplateLiteral5(["cold medicine cabinet"]))), "Swap to cold medicine cabinet"], [$item(_templateObject411 || (_templateObject411 = _taggedTemplateLiteral5(["Asdon Martin keyfob (on ring)"]))), "Swap to asdon martin keyfob"], [$item(_templateObject510 || (_templateObject510 = _taggedTemplateLiteral5(["TakerSpace letter of Marque"]))), "Swap to TakerSpace letter of Marque"]];
var args = Args.create("loopsmol", 'This is a script to complete Shrunken Adventurer Softcore runs. Run "loopsmol sim" without quotes to check if this script will work for you.\n\nYou must ascend manually into a Shrunken Adventurer Softcore run before running the script. Seal Clubber under a Vole sign is recommended for now. Astral mask or astral belt are both useful, but neither is required.\n\nThe arguments accepted by the script are listed below. Note that you can combine multiple options; for example "loopsmol pulls=18 fax=false" will save 2 pulls and avoid using a faxbot. Most options also have an associated setting to set an option permanently; for example "set loopsmol_pulls=18" will cause the script to always save 2 pulls (unless overriden by using the pulls option at runtime).', {
  ...
  major: Args.group("Major Options", {
    ...
    workshed: Args.item({
      ...
      default: $item(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral5(["model train set"]))),
      options: worksheds
    }),
    swapworkshed: Args.item({
      help: "Workshed item to place in a workshed to replace the cold medicine cabinet.",
      default: $item(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral5(["none"]))),
      options: worksheds
    })
  }),
...
function main() {
  if ((0, import_mafia_shared_relay.handleApiRequest)()) return;
